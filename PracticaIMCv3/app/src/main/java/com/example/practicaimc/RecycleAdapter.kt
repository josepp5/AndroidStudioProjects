...
class RecycleAdapter(context: Context, items: List<Measurement>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.pesoView.text = String.format("%.2f", item.peso)
        holder.alturaView.text = String.format("%.2f", item.altura)
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        val alturaView: TextView = view.lblAltura
        val pesoView: TextView = view.lblPeso
    }
}